...
(defconst svn-psvn-revision "2013-07-16, 01:08:49" "The revision date of psvn. Make psvn compatible with svn 1.7+")

;; Taken from https://github.com/klang/elisp/blob/master/site/dominating-file.el
;; Port this functionality back from Emacs 23. Still risky as it is not yet fully tested
...
and return the directory.  Return nil if not found."
  ...
  (defvar locate-dominating-stop-dir-regexp
    "\\`\\(?:[\\/][\\/][^\\/]+\\|/\\(?:net\\|afs\\|\\.\\.\\.\\)/\\)\\'"))
;; Done porting 'locate-dominating-file
